...
class MyStyle {
  ...
  String detail1 =
      '1. ให้กล้องห่างจากเท้าในระยะ 40 ซม. หรือ 16 นิ้ว เท่านั้น\n2. ให้ปลายส้นเท้าซ้ายหรือขวา(เพียงข้างเดียว) และส้นของเท้าอยู่ชิดติดเส้นสีส้มในแนวตั้ง\n3. เลื่อนลูกศรขึ้น - ลง เพื่อให้เส้นประสีน้ำเงินกระพริบ ชิดปลายนิ้วที่ยาวที่สุดของเท้าลูกค้า เพื่อวัดความยาวของเท้า\n4. ระบบจะแสดงความยาวของเท้าและเบอร์รองเท้าที่เหมาะสมของลูกค้า โดยเพื่อความสบายในการใส่ ลูกค้าสามารถเลื่อนลูกศรขึ้น - ลง เพื่อเลือกความยาวของเท้าหรือเบอร์รองเท้าที่ท่านต้องการ เมื่อถูกต้องให้กดถ่าย';
  String detail2 =
      '1. ห้ามใส่เสื้อคลุมหรือใส่ชุดที่จะทำให้การวัดขนาดของเอวท่านไม่ตรงกับความเป็นจริง\n2. ให้ขยับกล้องขึ้นลงเพื่อให้แกนสีแดงและสีส้มตรงกับตำแหน่งของการใส่เข็มขัดจริงของคุณลูกค้า ระบบจะแสดงขนาดรอบเอวขั้นต้นออกมา(เพื่อป้องกันข้อมูลคลาดเคลื่อน กรุณาให้เส้นแดงและเหลืองอยู่ในระดับที่ใส่เข็มขัดจริงเท่านั้น)\n3. ลูกค้าสามารถใช้นิ้วกดค้างที่เส้นสีเขียวเพื่อเลื่อนตำแหน่งเข้า-ออก เพื่อให้แสดงข้อมูลของการวัดที่ถูกต้องที่สุด เมื่อถูกต้องให้กดถ่าย';
 // String detail2 =
